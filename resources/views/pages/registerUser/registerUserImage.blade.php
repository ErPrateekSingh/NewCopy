        ...
        <div class="col-md-10 col-md-offset-1 col-xs-12">
            ...
            <div class="panel panel-form clearfix" style="border-color: #ccc;">
                <div class="panel-circle">
                  <i class="fa fa-camera" style="margin-top: 8px;"></i>
                  <span style="line-height: 1.1;">User<br>Image</span>
                </div>
        ...
        $('#userImage').on('change', function() {
            ...
            if (this.files && this.files[0]) {
                if (this.files[0].type.match(/^image\//)) {
                    ...
                    reader.onload = function(evt) {
                        ...
                        img.onload = function() {
                            ...
                            if (imgwidth >= minwidth && imgheight >= minheight) {
                                ...
                                $("#error_userImage").addClass("error").text("Minimum Image size must be 250px X 250px!");
                                valid = false;
                            }
                        };
                    ...
                    $("#error_userImage").addClass("error").text("Invalid file type! Please select an image file!");
                    valid = false;
                }
            } else {
                valid = false;
